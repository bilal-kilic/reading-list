...
class HeaderIntercepting {
     ...
     */
    companion object Feature : BaseApplicationPlugin<ApplicationCallPipeline, Configuration, HeaderIntercepting> {
        override val key: AttributeKey<HeaderIntercepting> = AttributeKey("Header Intercepting")
        override fun install(pipeline: ApplicationCallPipeline, configure: Configuration.() -> Unit): HeaderIntercepting {

...
class ErrorHandling {
     ...
     */
    companion object Feature : BaseApplicationPlugin<ApplicationCallPipeline, Configuration, ErrorHandling> {
        override val key: AttributeKey<ErrorHandling> = AttributeKey("Error Handling Key")
        override fun install(pipeline: ApplicationCallPipeline, configure: Configuration.() -> Unit): ErrorHandling {
